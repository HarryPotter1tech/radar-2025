...
namespace radar.webcamera
{
    public class RaycastCameraType
    {
        ...
        public RaycastCameraType(GameObject parentObject, RenderTexture renderTexture, string name = "RaycastCamera(Default)")
        {
            ...
            raycastCamera_.usePhysicalProperties = true;
            raycastCamera_.sensorSize = new Vector2(22.3f, 14.8f);
            raycastCamera_.focalLength = 18f;
            raycastCamera_.gateFit = Camera.GateFitMode.Vertical;
